...
describe('HomePage Component', () => {
  ...
  it('add to cart buttons works', async () => {
    render(
      <MemoryRouter>
        <HomePage cart={[]} loadCart={loadCart}/>
      </MemoryRouter>
    ...
    await user.click(addToCartButton1); // Takes time to finish (async)
    ...
    await user.click(addToCartButton2); // Takes time to finish (async)
